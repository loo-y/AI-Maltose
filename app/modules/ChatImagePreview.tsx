...
const ChatImagePreview = ({
    ...
    return (
        <Dialog open={openPreview}>
            <DialogContent
                className="py-0 px-0 border-none bg-transparent active:outline-none focus:outline-none text-center justify-center flex items-center max-w-none shadow-none"
